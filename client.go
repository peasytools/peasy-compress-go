// Package peasyimage provides a Go client for the PeasyCompress API.
//
// PeasyCompress offers compression tools for files, images, and documents.
...
// DefaultBaseURL is the default PeasyCompress API base URL.
const DefaultBaseURL = "https://peasytools.com"

// DefaultTimeout is the default HTTP client timeout.
const DefaultTimeout = 30 * time.Second

// Client is the PeasyCompress API client.
type Client struct {
	baseURL    string
...
// New creates a new PeasyCompress API client.
...
func (c *Client) doRequest(ctx context.Context, path string, params url.Values) ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: create request: %w", err)
	}
	resp, err := c.httpClient.Do(req)
	if err != nil {
		return nil, fmt.Errorf("peasycompress: http request: %w", err)
	}
	defer resp.Body.Close()
	body, err := io.ReadAll(resp.Body)
	if err != nil {
		return nil, fmt.Errorf("peasycompress: read response: %w", err)
	}
...
func decodePaginated[T any](data []byte, method string) (*PaginatedResponse[T], error) {
	...
	if err := json.Unmarshal(data, &pr); err != nil {
		return nil, fmt.Errorf("peasycompress: decode %s: %w", method, err)
	}
	return &pr, nil
}
...
func (c *Client) ListTools(ctx context.Context, opts ...ListOptions) (*PaginatedResponse[Tool], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list tools: %w", err)
	}
...
func (c *Client) GetTool(ctx context.Context, slug string) (*Tool, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: get tool: %w", err)
	}
	var t Tool
	if err := json.Unmarshal(data, &t); err != nil {
		return nil, fmt.Errorf("peasycompress: decode tool: %w", err)
	}
	return &t, nil
}
...
func (c *Client) ListCategories(ctx context.Context, opts ...ListOptions) (*PaginatedResponse[Category], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list categories: %w", err)
	}
...
func (c *Client) ListFormats(ctx context.Context, opts ...ListOptions) (*PaginatedResponse[Format], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list formats: %w", err)
	}
...
func (c *Client) GetFormat(ctx context.Context, slug string) (*Format, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: get format: %w", err)
	}
	var f Format
	if err := json.Unmarshal(data, &f); err != nil {
		return nil, fmt.Errorf("peasycompress: decode format: %w", err)
	}
	return &f, nil
}
...
func (c *Client) ListConversions(ctx context.Context, opts ...ListConversionsOptions) (*PaginatedResponse[Conversion], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list conversions: %w", err)
	}
...
func (c *Client) ListGlossary(ctx context.Context, opts ...ListOptions) (*PaginatedResponse[GlossaryTerm], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list glossary: %w", err)
	}
...
func (c *Client) GetGlossaryTerm(ctx context.Context, slug string) (*GlossaryTerm, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: get glossary term: %w", err)
	}
	var t GlossaryTerm
	if err := json.Unmarshal(data, &t); err != nil {
		return nil, fmt.Errorf("peasycompress: decode glossary term: %w", err)
	}
	return &t, nil
}
...
func (c *Client) ListGuides(ctx context.Context, opts ...ListGuidesOptions) (*PaginatedResponse[Guide], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list guides: %w", err)
	}
...
func (c *Client) GetGuide(ctx context.Context, slug string) (*Guide, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: get guide: %w", err)
	}
	var g Guide
	if err := json.Unmarshal(data, &g); err != nil {
		return nil, fmt.Errorf("peasycompress: decode guide: %w", err)
	}
	return &g, nil
}
...
func (c *Client) ListUseCases(ctx context.Context, opts ...ListOptions) (*PaginatedResponse[UseCase], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list use cases: %w", err)
	}
...
func (c *Client) Search(ctx context.Context, query string, opts ...SearchOptions) (*SearchResult, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: search: %w", err)
	}
	var sr SearchResult
	if err := json.Unmarshal(data, &sr); err != nil {
		return nil, fmt.Errorf("peasycompress: decode search: %w", err)
	}
	return &sr, nil
}
...
func (c *Client) ListSites(ctx context.Context) (*PaginatedResponse[Site], error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: list sites: %w", err)
	}
...
func (c *Client) OpenAPISpec(ctx context.Context) (json.RawMessage, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("peasycompress: openapi spec: %w", err)
	}
